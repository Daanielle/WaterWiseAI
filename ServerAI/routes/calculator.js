...
//   try {
//     const { selectedArea, areaSize, selectedKc } = req.body;
...
router.post('/calculate', async (req, res) => {
  try {
    let { selectedArea, areaSize, date } = req.body;
    let lastBatch;
...
//           recommendation,
//           station
//       } = req.body; // Access the data directly if not nested under 'recommendation'

//       console.log('Received data:', req.body); // Log the entire request body for debugging
//       console.log('Extracted userId:', userId); // Log the userId to verify its value
...
// function co  mputeDeltaY(temperature) {
//   const deltaYTable = [
//     { temp: 0, deltaY: 1.456 },
//     { temp: 5, deltaY: 1.067 },
//     { temp: 10, deltaY: 0.7934 },
